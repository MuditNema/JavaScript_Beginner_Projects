In this project , I made a real-time weather application which can be used to see the current weather conditions of any Indian city. It also shows the forecast for next 4 days.
